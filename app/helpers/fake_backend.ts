...
//     global.fetch = jest.run((url: string, opts: any) => {
...
//             function ok(body: any | Promise<any> = undefined) {
...
//             function error(message: string | PromiseLike<string>) {
//                 resolve({ status: 400, headers: headers(), json: () => Promise.resolve({ message }) }) as Response
//             }
